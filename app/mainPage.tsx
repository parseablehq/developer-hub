...
export default function MainPage() {
  ...
  return (
    <main className="flex-1 bg-[#F8F9FA] dark:bg-[#101622] text-slate-900 dark:text-white overflow-x-hidden">
      <div className="flex flex-col w-full max-w-[1088px] flex-1 px-4 sm:px-6 lg:px-8 mx-auto">
        ...
        <div className="space-y-16">
          ...
          <section className="rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 p-8 sm:p-12 text-center">
            ...
            <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-4">
              ...
              >
                <svg className="mr-2 w-6 h-6" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M7 16a4 4 0 01-.88-7.903A5 5 0 1115.9 6L16 6a5 5 0 011 9.9M15 13l-3-3m0 0l-3 3m3-3v12" />
                </svg>
                <span className="truncate">Sign up now</span>
              </Link>
              <Link
                href={`${baseUrl}quickstart`}
          ...
          <section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
              {[
                { icon: "architecture", title: "Architecture", href: `${baseUrl}architecture` },
                { icon: "design_services", title: "Design Choices", href: `${baseUrl}design-choices` },
                { icon: "database", title: "Data Modelling", href: `${baseUrl}key-concepts` },
                { icon: "input", title: "Ingestion", href: `${baseUrl}datasource` },
                { icon: "query_stats", title: "Query", href: `${baseUrl}key-concepts/query` },
              ].map((item, index) => (
                <Link
                  key={index}
                  href={item.href}
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              >
                ...
                <div className="relative z-10">
                  <svg className="w-10 h-10 text-violet-600 dark:text-violet-400" fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24">
              ...
              >
                ...
                <div className="relative z-10">
                  <svg className="w-10 h-10 text-sky-600 dark:text-sky-400" fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24">
              ...
              >
                ...
                <div className="relative z-10">
                  <svg className="w-10 h-10 text-emerald-600 dark:text-emerald-400" fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24">
        ...
        <footer className="mt-24 border-t border-slate-200 dark:border-slate-800 py-8">
          <div className="flex flex-col md:flex-row justify-between items-center text-sm gap-4">
            <p className="text-slate-500 dark:text-slate-400">© 2025 Parseable Inc.</p>
