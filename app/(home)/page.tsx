          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-slate-800 p-8 rounded-lg shadow-lg hover:shadow-blue-500/30 transition-shadow">
              <div className="flex items-center mb-4">
                <div className="text-blue-500 mr-4" style={{ fontSize: '2.25rem' }}>
            ...
            <div className="bg-slate-800 p-8 rounded-lg shadow-lg hover:shadow-green-500/30 transition-shadow">
              <div className="flex items-center mb-4">
                <div className="text-green-500 mr-4" style={{ fontSize: '2.25rem' }}>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              <div key={index} className="bg-slate-800 rounded-lg p-6 hover:bg-slate-750 transition-colors">
                <div className={`${card.color} mb-3`} style={{ fontSize: '2.25rem' }}>
                  {card.icon}
                </div>
                ...
                <ul className="space-y-2">
                  {card.links.map((link, linkIndex) => (
                    <li key={linkIndex}>
                      <Link href={link.href} className="text-blue-400 hover:text-blue-300 text-sm flex items-center">
                        <span className="mr-1" style={{ fontSize: '0.875rem' }}><ArrowForwardIcon fontSize="inherit" /></span> {link.text}
                      </Link>
                    </li>
                  ))}
                </ul>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="border-t border-slate-700 pt-8 flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex space-x-4">
              ...
              <Link href="https://x.com/parseablehq" className="text-slate-400 hover:text-slate-200 transition-colors">
                <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
