...
const URL_MAPPINGS: Array<{ pattern: RegExp; replacement: string }> = [
  ...
  { pattern: /^\/installation\/kubernetes-helm/, replacement: '/self-hosted/installation/distributed/k8s-helm-oss' },
  { pattern: /^\/installation\/setup-parseable-on-kubernetes/, replacement: '/self-hosted/installation/distributed/k8s-helm-oss' },
  ...
  { pattern: /^\/installation\/standalone\/setup-parseable-on-kubernetes/, replacement: '/self-hosted/installation/standalone/k8s-oss' },
  ...
  { pattern: /^\/installation\/distributed\/setup-distributed-parseable-on-kubernetes/, replacement: '/self-hosted/installation/distributed/k8s-helm-oss' },
