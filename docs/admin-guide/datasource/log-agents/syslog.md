---
title: "Syslo-ng"
description: Syslo-ng log agent for Parseable
sidebar_position: 6
---
...
docker-compose up -d
```
You can now access the Parseable dashboard on `http://localhost:8000`. You should see a log stream called `demo` populated with log data generated by the [flog container](https://github.com/mingrammer/flog).