...
| [`pb tail`](/docs/pb-cli/tail) | Stream live log events from a dataset in real time as newline-delimited JSON |
| [`pb dataset`](/docs/pb-cli/datasets) | List, create, inspect, and delete log, metrics, and traces datasets |
| [`pb user`](/docs/pb-cli/admin) | Create users, assign roles, and manage user access |
| [`pb role`](/docs/pb-cli/admin) | Define roles with specific privilege levels and dataset scopes |
