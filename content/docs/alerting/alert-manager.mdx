...
redirect_from:
  ...
  - /server/integrations/alertmanager-integration
...
- Parseable server installed and running. See [installation guide](/self-hosted/installation) for more details.
...
To configure Parseable alerts to be sent to Alertmanager, use the alertmanager [target type](/user-guide/alerting#alertmanager) in Parseable alert configuration.
