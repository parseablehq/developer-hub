...
<Card href="/docs/OpenTelemetry/logs" icon={<IconFileText className="text-purple-600" />} title='Logs'>
...
<Card href="/docs/OpenTelemetry/metrics" icon={<IconChartBar className="text-purple-600" />} title='Metrics'>
Capture and visualize OpenTelemetry metrics to monitor the performance and health of your systems in real-time.
</Card>

<Card href="/docs/OpenTelemetry/traces" icon={<IconRoute className="text-purple-600" />} title='Traces'>
