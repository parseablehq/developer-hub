...
You can add supported environment variables to `parseable-env-secret` as needed. See the [environment variables documentation](/docs/self-hosted/configuration).
