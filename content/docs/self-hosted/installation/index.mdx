...
- [Kubernetes](/self-hosted/installation/distributed/k8s-helm-oss)
- [Docker Compose](/self-hosted/installation/distributed/docker-compose)
- [Bare Metal and VMs](/self-hosted/installation/distributed/linux)
- [Railway](/self-hosted/installation/distributed/railway)
...
- [Kubernetes](/self-hosted/installation/standalone/k8s-oss)
- [Docker](/self-hosted/installation/standalone/docker)
- [Bare Metal and VMs](/self-hosted/installation/standalone/linux)
- [Railway](/self-hosted/installation/standalone/railway)
