...
title: AWS ECS
redirect_from:
  - /installation/standalone/aws-ecs
---
...
```
You can add additional environment variables to the task definition as needed. You can find the details of all the environment variables in the [Environment Variables](/self-hosted/configuration) section.
