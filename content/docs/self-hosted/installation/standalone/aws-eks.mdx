...
redirect_from:
  ...
  - /server/installation/standalone/setup-parseable-on-aws-eks
  - /installation/eks
---

This page explains additional EKS specific features and configuration options for Parseable. For general Parseable installation instructions, see [installation documentation](/self-hosted/installation).
