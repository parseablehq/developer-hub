...
redirect_from:
  ...
  - /server/installation/standalone/setup-parseable-on-docker
  - /installation/setup-parseable-on-docker
  - /installation/docker
---
...
You can add additional environment variables to the `parseable-env` file as needed. You can find the details of all the environment variables in the [Environment Variables](/self-hosted/configuration) section.
