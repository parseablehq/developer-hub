...
[AWS EKS guide](/self-hosted/installation/standalone/aws-eks) to configure
...
- Configure [CloudWatch integration](/ingest-data/cloud/aws-cloudwatch) for AWS logs
- Set up [alerts](/user-guide/alerting) for storage metrics
