...
| `P_LOCAL_SYNC_THRESHOLD` | `No` | Local sync threshold in seconds. Time within which local sync (staging to disk) should complete. | `30` | `60` |
| `P_OBJECT_STORE_SYNC_THRESHOLD` | `No` | Object store sync threshold in seconds. Time within which object store sync should complete. | `15` | `30` |
