...
| `P_MEMORY_THRESHOLD` | `No` | Specify the memory threshold to use for Parseable server. | `80` | `100` |
| `P_CPU_THRESHOLD` | `No` | Specify the CPU threshold to use for Parseable server. | `80` | `100` |
...
Refer to [OIDC](/docs/features/oepnid) section for more details.