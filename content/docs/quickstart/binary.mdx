...
To query the data via Console, login at http://localhost:8000. Default username and password is `admin:admin`. Then select the dataset demo and correct time stamp.
