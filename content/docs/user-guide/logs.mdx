...
Select the log dataset from the breadcrumb at the top of the page. The rest of the page updates for that dataset, including the available fields, filters, chart, and table columns.
...
The goal is not to read every log line. Use the page to narrow the data until the records you need are easy to inspect.
