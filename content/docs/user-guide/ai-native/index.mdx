...
<LocalVideo src="/docs-videos/keystone.mp4" title="Keystone AI-native observability workflow" />

[Learn more about Keystone →](/user-guide/ai-native/keystone)
...
[Learn more about Summarization →](/user-guide/ai-native/summary)
...
[Learn more about Text to SQL →](/user-guide/ai-native/text-to-sql)

See also: [Parseable AI Assistant](/llm/text-to-sql) for advanced LLM configuration options.
