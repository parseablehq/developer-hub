---
title: Traces
description: Search, filter, and analyze distributed traces with the Traces explorer interface
---
...
![Traces explorer page overview](../static/traces-explore.png)
...
![Trace detail view with waterfall and span detail](../static/traces-explore-detail.png)
