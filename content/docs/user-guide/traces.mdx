...
The **Traces** tab is the main place to start. It shows trace duration over time as bubble markers and lists the matching traces below the chart.

Each marker represents a trace. Its position shows when the trace happened and how long it took. Larger markers usually point to traces with more spans. Hover over a marker to see the service, span name, duration, and span count.
