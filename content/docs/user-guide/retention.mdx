...
redirect_from:
  - /features/retention
  - /server/features/retention
  - /server/features/setting-retention-for-log-stream
  - /features/setting-retention-for-log-stream
---
...
## Setting up
You can set Retention via the Dataset Management page (Dataset >> Manage >> Retention). If you're using external applications to interact with Parseable, you can also use the retention API calls. Refer to the [API documentation](/api) for details.
