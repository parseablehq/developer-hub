...
<Card href="/docs/ingest-data/otel" icon={<IconTimeline className="text-purple-600" />} title='OpenTelemetry'>
...
<Card href="/docs/ingest-data/cloud/aws-cloudwatch" icon={<IconSettings className="text-blue-600" />} title='AWS CloudWatch'>
Ingest logs and metrics from AWS CloudWatch service.
</Card>

<Card href="/docs/ingest-data/cloud/aws-kinesis" icon={<IconSettings className="text-blue-600" />} title='AWS Kinesis'>
Stream data from AWS Kinesis Data Streams to Parseable.
</Card>

<Card href="/docs/ingest-data/cloud/azure-event-hubs" icon={<IconSettings className="text-blue-600" />} title='Azure Event Hubs'>
Ingest streaming data from Azure Event Hubs.
</Card>

<Card href="/docs/ingest-data/cloud/gcp-pubsub" icon={<IconSettings className="text-blue-600" />} title='GCP Pub/Sub'>
...
<Card href="/docs/ingest-data/llm-agents/openai" icon={<IconCode className="text-purple-600" />} title='OpenAI'>
Track and log OpenAI API calls and responses.
</Card>

<Card href="/docs/ingest-data/llm-agents/anthropic" icon={<IconCode className="text-purple-600" />} title='Anthropic'>
Monitor and log Anthropic Claude API interactions.
</Card>

<Card href="/docs/ingest-data/llm-agents/langchain" icon={<IconCode className="text-purple-600" />} title='LangChain'>
Ingest traces and logs from LangChain applications.
</Card>

<Card href="/docs/ingest-data/llm-agents/llamaindex" icon={<IconCode className="text-purple-600" />} title='LlamaIndex'>
Collect observability data from LlamaIndex applications.
</Card>

<Card href="/docs/ingest-data/llm-agents/dspy" icon={<IconCode className="text-purple-600" />} title='DSPy'>
Monitor DSPy framework executions and outputs.
</Card>

<Card href="/docs/ingest-data/llm-agents/autogen" icon={<IconCode className="text-purple-600" />} title='AutoGen'>
Track multi-agent conversations and AutoGen workflows.
</Card>

<Card href="/docs/ingest-data/llm-agents/crewai" icon={<IconCode className="text-purple-600" />} title='CrewAI'>
Ingest logs from CrewAI agent orchestration.
</Card>

<Card href="/docs/ingest-data/llm-agents/n8n" icon={<IconCode className="text-purple-600" />} title='n8n'>
