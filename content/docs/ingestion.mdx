...
For log data you can use the HTTP output plugins of all the logging agents/shippers. You can also directly integrate Parseable with your application via the [ingestion API](/docs/api/v1/ingestLogsWithHeaders).
...
<Card href="/docs/ingest-data/databases/sql-server" icon={<IconDatabase className="text-gray-600" />} title='Microsoft SQL Server'>
...
<Card href="/docs/ingest-data/infrastructure/windows-server" icon={<IconServer className="text-blue-600" />} title='Windows Server'>
