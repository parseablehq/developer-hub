...
---
import { IconCpu2,IconSortDescendingSmallBig,IconBolt,IconTelescope,IconFileTextShield } from '@tabler/icons-react';
...
<Card icon={<IconTelescope />} title='Object store first'>
