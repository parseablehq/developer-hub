...
Parseable is a modern observability platform, built for unifying observability signals.

At the core of Parseable is purpose built, disk-less database [Parseable DB](https://github.com/parseablehq/parseable). ParseableDB is built ground up on the principles of simplicity, performance and efficiency. It is designed to handle large volumes of telemetry data, like logs, metrics, and traces, with a focus on efficient data ingestion, storage and fast querying.
