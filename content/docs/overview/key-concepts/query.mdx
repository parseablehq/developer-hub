...
**References:**
- [SQL Editor User Guide](/user-guide/sql-editor) - Query examples and usage
- [Text to SQL](/user-guide/ai-native/text-to-sql) - AI-powered query generation
- [Query API](/api/query) - REST API documentation
