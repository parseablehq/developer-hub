...
Open the console at [http://localhost:8000](http://localhost:8000) and sign in with `admin` / `admin`. For other install options and a full walkthrough, see the [Docker quickstart](/docs/quickstart/docker).

## Editions

Parseable is available in three editions. <a href="/docs/editions/compare">Compare editions ↗︎</a>
