...
```
You can add additional environment variables to the task definition as needed. You can find the details of all the environment variables in the [Environment Variables](/docs/env-variables) section.
