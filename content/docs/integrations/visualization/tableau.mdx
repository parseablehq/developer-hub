...
For real-time connectivity, we recommend using [Apache Superset](/integrations/visualization/apache-superset) which has native Parseable support via the `sqlalchemy-parseable` driver.
...
4. **Consider Apache Superset** - For real-time dashboards, use [Apache Superset](/integrations/visualization/apache-superset) with native Parseable support

## Next Steps

- Create [dashboards](/user-guide/dashboards) in Parseable's built-in UI
- Set up [alerts](/user-guide/alerting) for anomalies
