...
2. Configure:
   - **Allowed Callback URLs**: `https://your-parseable.com/api/v1/o/code`
...
P_ORIGIN_URI=https://your-parseable.com
```
...
1. Verify the Auth0 callback URL is `https://your-parseable.com/api/v1/o/code`
2. Make sure `P_ORIGIN_URI` is the public base URL, for example `https://your-parseable.com`
3. Check for http vs https and confirm the domain is correct
...
- Configure [OAuth](/user-guide/openid) for other providers
- Set up [RBAC](/user-guide/rbac) in Parseable
- Review [security best practices](/user-guide/rbac)
