...
3. Configure:
   ...
   - **Redirect URI**: Web - `https://your-parseable.com/api/v1/o/code`
4. Click **Register**
...
3. Configure:
   - **Redirect URIs**: `https://your-parseable.com/api/v1/o/code`
...
|------|-------------|----------|
| AADSTS50011 | Reply URL mismatch | Check that the redirect URI is `https://your-parseable.com/api/v1/o/code` |
