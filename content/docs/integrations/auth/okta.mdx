...
3. **Sign-in redirect URIs**: `https://your-parseable.com/api/v1/o/code`
...
1. Verify the Okta redirect URI is `https://your-parseable.com/api/v1/o/code`
2. Make sure `P_ORIGIN_URI` is the public base URL, for example `https://your-parseable.com`
3. Check client ID, client secret, and issuer URL format
