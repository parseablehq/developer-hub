...
6. Configure URLs:
   ...
   - **Valid redirect URIs**: `https://your-parseable.com/api/v1/o/code`
...
2. Check that the valid redirect URI is `https://your-parseable.com/api/v1/o/code`
3. Make sure `P_ORIGIN_URI` is the public base URL, for example `https://your-parseable.com`
