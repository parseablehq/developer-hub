...
- Set up [Parseable alerts](/user-guide/alerting) for automated notifications
- Configure [Slack](/integrations/alerting/slack) for team notifications
- Configure [PagerDuty](/integrations/alerting/pagerduty) for incident management
