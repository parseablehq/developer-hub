...
function generateEmailHtml(alert) {
  ...
  return `
    ...
    <body>
      ...
      <div class="content">
        <div class="field">
          <span class="label">Stream:</span> ${alert.stream || 'N/A'}
        </div>
        <div class="field">
        ...
        <p>
          <a href="https://your-parseable.com/streams/${alert.stream}">View in Parseable</a>
        </p>
      </div>
      <div class="footer">
...
View in Parseable: https://your-parseable.com/streams/${alert.stream}
  `;
}
