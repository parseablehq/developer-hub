...
<Card href="/docs/ingest-data/languages/ruby" title="Ruby">
Ruby logging integration
</Card>
<Card href="/docs/ingest-data/languages/php" title="PHP">
PHP logging integration
</Card>
<Card href="/docs/ingest-data/languages/dotnet" title=".NET">
