...
<Card href="/docs/ingest-data/cloud/aws-s3" title="AWS S3">
...
<Card href="/docs/ingest-data/cloud/azure-blob-storage" title="Azure Blob Storage">
...
<Card href="/docs/ingest-data/cloud/gcp-storage" title="Google Cloud Storage">
Store logs in GCS
</Card>
<Card href="/docs/ingest-data/cloud/digitalocean-spaces" title="DigitalOcean Spaces">
