...
<Cards>
<Card href="/docs/self-hosted/aws" title="AWS Overview">
...
<Card href="/docs/ingest-data/cloud/aws-data-firehose" title="AWS Data Firehose">
Direct integration with Data Firehose
</Card>
<Card href="/docs/ingest-data/cloud/aws-lambda" title="AWS Lambda">
...
<Card href="/docs/ingest-data/cloud/azure-api-service" title="Azure API Service">
Azure API Management logs via Event Hub and Logic Apps
</Card>
<Card href="/docs/ingest-data/cloud/azure-service-bus" title="Azure Service Bus">
...
<Cards>
<Card href="/docs/ingest-data/cloud/fly-io" title="Fly.io">
...
<Cards>
<Card href="/docs/integrations/data-platforms/starburst-galaxy" title="Starburst Galaxy">
...
<Card href="/docs/ingest-data/ai-agents/daytona" title="Daytona">
SDK traces, sandbox logs, traces, and metrics
</Card>
<Card href="/docs/ingest-data/ai-agents/dbos" title="DBOS">
DBOS workflows, logs, traces, and Conductor metrics
</Card>
<Card href="/docs/ingest-data/ai-agents/temporal" title="Temporal">
Temporal workflows, activities, and agent orchestration
</Card>
<Card href="/docs/ingest-data/ai-agents/modal" title="Modal">
Send Modal logs, traces and metrics to Parseable through OpenTelemetry Collector
</Card>
<Card href="/docs/ingest-data/ai-agents/restate" title="Restate">
