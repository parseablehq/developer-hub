...
Then use [GCP Pub/Sub integration](/docs/integrations/cloud/gcp-pubsub) to forward to Parseable.
...
- Configure [Azure AKS](/docs/integrations/containers/azure-aks) for multi-cloud
