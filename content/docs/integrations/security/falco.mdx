...
helm install falco falcosecurity/falco \
  ...
  --set falcosidekick.config.webhook.customHeaders="Authorization:Basic YWRtaW46YWRtaW4=,X-P-Stream:falco-events"
```
...
- Configure [Trivy](/docs/integrations/security/trivy) for vulnerability scanning
