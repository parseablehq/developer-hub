...
- A running [Parseable deployment](/get-started)
...
For Kubernetes collection, follow the [Kubernetes guide](/ingest-data/containers/kubernetes).
...
See the [OpenTelemetry logs](/ingest-data/otel/logs), [metrics](/ingest-data/otel/metrics), and [traces](/ingest-data/otel/traces) documentation for signal-specific details.
