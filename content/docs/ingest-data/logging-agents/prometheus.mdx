...
`X-API-Key` authorizes the write to Parseable. `X-P-Stream` decides the target metrics dataset, tells Parseable to treat the incoming payload as metrics data.
