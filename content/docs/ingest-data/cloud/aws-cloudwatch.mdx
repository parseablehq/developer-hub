...
- Set up [alerts](/user-guide/alerting) for AWS log patterns
- Create [dashboards](/user-guide/dashboards) for AWS monitoring
- Configure [AWS S3](/self-hosted/storage-targets/aws-s3) for log storage
