...
redirect_from:
  - /server/aws/kinesis
  - /server/cloud-providers/aws/kinesis
  - /aws/kinesis
  - /cloud-providers/aws/kinesis
---
...
- Set up [AWS CloudWatch](/ingest-data/cloud/aws-cloudwatch) for CloudWatch logs
- Configure [alerts](/user-guide/alerting) for streaming metrics
