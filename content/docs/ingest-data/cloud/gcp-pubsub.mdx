...
- Set up [alerts](/user-guide/alerting) for GCP log patterns
- Create [dashboards](/user-guide/dashboards) for GCP monitoring
- Configure [AWS CloudWatch](/ingest-data/cloud/aws-cloudwatch) for multi-cloud
