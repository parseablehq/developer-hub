...
- Configure [alerts](/user-guide/alerting) for error patterns
- Create [dashboards](/user-guide/dashboards) for Ruby metrics
- Explore [OpenTelemetry](/ingest-data/otel) for tracing
