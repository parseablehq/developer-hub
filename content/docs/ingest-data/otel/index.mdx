...
<Card href="/ingest-data/otel/logs" icon={<IconFileText className="text-purple-600" />} title='Logs'>
...
<Card href="/ingest-data/otel/metrics" icon={<IconChartBar className="text-purple-600" />} title='Metrics'>
Capture and visualize OpenTelemetry metrics to monitor the performance and health of your systems in real-time.
</Card>

<Card href="/ingest-data/otel/traces" icon={<IconRoute className="text-purple-600" />} title='Traces'>
