...
Use separate datasets for traces and metrics. Parseable identifies each telemetry signal from its OTLP endpoint.
...
For a Pydantic AI example, see [Pydantic AI](/ingest-data/ai-agents/pydantic-ai).
