...
- Set up [alerts](/user-guide/alerting) for infrastructure changes
- Create [dashboards](/user-guide/dashboards) for IaC metrics
- Configure [ArgoCD](/ingest-data/cicd/argocd) for GitOps
