...
- Set up [alerts](/user-guide/alerting) for failed deployments
- Create [dashboards](/user-guide/dashboards) for GitOps metrics
- Configure [GitHub Actions](/ingest-data/cicd/github-actions) for CI
