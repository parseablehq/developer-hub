...
- Configure [LlamaIndex](/ingest-data/ai-agents/llamaindex) tracing
- Set up [OpenAI](/ingest-data/ai-agents/openai) direct logging
- Create [dashboards](/user-guide/dashboards) for chain metrics
