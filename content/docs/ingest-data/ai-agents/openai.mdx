...
- Configure [Anthropic](/ingest-data/ai-agents/anthropic) logging
- Set up [LangChain](/ingest-data/ai-agents/langchain) tracing
- Create [dashboards](/user-guide/dashboards) for LLM metrics
- Set up [alerts](/user-guide/alerting) for cost thresholds
