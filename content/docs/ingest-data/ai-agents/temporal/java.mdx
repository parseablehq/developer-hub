...
The [`com.parseable:temporal-parseable`](https://central.sonatype.com/artifact/com.parseable/temporal-parseable) plugin is a [Temporal](https://temporal.io/) middleware that ships workflow and activity execution events to Parseable. See the [Temporal overview](./) for the full schema, example queries, and shared caveats.
...
- Maven Central package: [central.sonatype.com/artifact/com.parseable/temporal-parseable](https://central.sonatype.com/artifact/com.parseable/temporal-parseable)
