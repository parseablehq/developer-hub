...
Mastra loads the trace and log OTLP exporters dynamically. Keep both HTTP exporter packages installed; otherwise the corresponding signal is disabled and Mastra reports a missing exporter package at runtime.
