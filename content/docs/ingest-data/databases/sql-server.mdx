...
![SQL Server logs in Parseable](./static/sqlserver-logs.png)

![SQL Server metrics in Parseable](./static/sqlserver-metrics.png)

![SQL Server traces in Parseable](./static/sqlserver-traces.png)
