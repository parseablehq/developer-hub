...
![PostgreSQL logs in Parseable](./static/postgres-logs.png)

![PostgreSQL metrics in Parseable](./static/postgres-metrics.png)

![PostgreSQL traces in Parseable](./static/postgres-traces.png)
