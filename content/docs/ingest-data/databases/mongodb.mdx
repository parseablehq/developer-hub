...
![MongoDB logs in Parseable](./static/mongodb-logs.png)

![MongoDB metrics in Parseable](./static/mongodb-metrics.png)

![MongoDB traces in Parseable](./static/mongodb-traces.png)
