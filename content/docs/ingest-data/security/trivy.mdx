...
- Set up [alerts](/user-guide/alerting) for vulnerability thresholds
- Create [dashboards](/user-guide/dashboards) for security posture
- Configure [Falco](/ingest-data/security/falco) for runtime security
