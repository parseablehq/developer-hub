...
- Set up [alerts](/user-guide/alerting) for security events
- Create [dashboards](/user-guide/dashboards) for security monitoring
- Configure [Trivy](/ingest-data/security/trivy) for vulnerability scanning
