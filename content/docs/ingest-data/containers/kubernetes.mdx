...
- Configure [Amazon EKS](/ingest-data/containers/amazon-eks) for AWS
- Configure [Google GKE](/ingest-data/containers/google-gke) for GCP
- Configure [Azure AKS](/ingest-data/containers/azure-aks) for Azure
- Set up [alerts](/user-guide/alerting) for cluster events
- Create [dashboards](/user-guide/dashboards) for monitoring
