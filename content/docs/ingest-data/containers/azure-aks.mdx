...
Then use [Azure Event Hubs integration](/ingest-data/cloud/azure-event-hubs) to forward to Parseable.
...
- Configure [Amazon EKS](/ingest-data/containers/amazon-eks) for multi-cloud
- Set up [alerts](/user-guide/alerting) for AKS events
- Create [dashboards](/user-guide/dashboards) for cluster monitoring
