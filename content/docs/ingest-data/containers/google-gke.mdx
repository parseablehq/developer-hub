...
Then use [GCP Pub/Sub integration](/ingest-data/cloud/gcp-pubsub) to forward to Parseable.
...
- Configure [Azure AKS](/ingest-data/containers/azure-aks) for multi-cloud
- Set up [alerts](/user-guide/alerting) for GKE events
