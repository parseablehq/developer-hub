...
Then use [AWS CloudWatch integration](/ingest-data/cloud/aws-cloudwatch) to forward to Parseable.
...
- Configure [Amazon EKS](/ingest-data/containers/amazon-eks) for Kubernetes
- Set up [alerts](/user-guide/alerting) for container metrics
