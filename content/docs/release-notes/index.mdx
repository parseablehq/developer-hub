...
## v2.5.0 (August 17, 2025)

We're thrilled to announce Parseable v2.5.0, packed with powerful new features that enhance monitoring, visualization, and data ingestion capabilities. This release introduces advanced alerting mechanisms, expanded dashboard visualization options, and native Protocol Buffer support.

### 1. Advanced Alert Types

Building on our alerting capabilities, v2.5.0 introduces three sophisticated alert types to help you proactively monitor your systems. [Learn more about Alerts](/docs/features/alerts)
...
```bash
# Docker
docker pull parseable/parseable:v2.5.0

# Kubernetes
kubectl set image deployment/parseable parseable=parseable/parseable:v2.5.0
```
