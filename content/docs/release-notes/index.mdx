...
## v2.4.2 (September 22, 2025)

### 1. Support for SQL based Dashboard Charts

You can now build Dashboard charts using SQL queries. 
...
### 2. Revamped SQL Editor

The SQL editor has been revamped to provide a better experience.

Key Changes:

1. You can see all the fields of the dataset along with their data types.
2. New Chart Builder with more customization options.
...
### 3. Export Chart to Dashboard from SQL Editor

<Callout type="info">
  <EnterpriseBadge /> This feature requires an Enterprise license.
</Callout>

You can now export a chart to a dashboard from the SQL editor.

How it works:

- Under the SQL editor, once the Query is executed, click on the "Export to Dashboard" button.
...
### 4. Create Alert from Dashboard

You can now create alerts from the Dashboard.

How it works:

1. **Initiate Alert Creation**: Click on the "three dots" button in the chart and select "Create Alert" from the dropdown menu.
2. **Navigate to Alert Builder**: You will be seamlessly redirected to the Alert Builder page, where your current filters and group-by options are automatically applied.
3. **Configure Your Alert**: Customize the alert settings to suit your needs, including thresholds, notification preferences, and more.
4. **Finalize Alert Setup**: Once satisfied with the configuration, click "Create" to activate your alert.
...
### 5. Investigate from Dashboard

<Callout type="info">
  <EnterpriseBadge /> This feature requires an Enterprise license.
</Callout>

You can now drill down into the data from the Dashboard.
...
### 6. Investigate from triggered Alert

<Callout type="info">
  <EnterpriseBadge /> This feature requires an Enterprise license.
</Callout>

You can now drill down into the data from the triggered Alert.

How it works:

- Select the "Investigate" option from the Trigerred Alert page.
