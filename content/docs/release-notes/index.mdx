...
**Parseable v2.5.0** is here! This major update significantly expands our observability capabilities, introducing a dedicated **Trace View**, a reimagined **Metrics View**, and powerful AI-native integrations connecting Keystone with the alerting ecosystem.
