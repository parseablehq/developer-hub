---
title: "Logstash"
description: Logstash log agent for Parseable
sidebar_position: 5
---
...
docker-compose up -d
```
You can now access the Parseable dashboard on `http://localhost:8000`. You should see a log stream called `logstashlogs` populated with log data generated by the [generator](https://www.elastic.co/guide/en/logstash/current/input-plugins.html#input-generator) input plugin.