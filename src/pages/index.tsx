        ...
        <div className={styles.heroContent}>
          <div className={styles.heroText}>
            ...
            <div className={styles.heroButtons}>
              <Link to="/docs/docs/introduction" className={styles.heroButton}>
              ...
              <Link to="/docs/docs/installation" className={styles.heroButton}>
                <span className={styles.heroButtonIcon}>
                  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      <div className="container">
        ...
        <div className={styles.cardGrid}>
          ...
          <CardSection
            ...
            link="/docs/docs/key-concepts/ingestion"
          ...
          <CardSection
            ...
            link="/docs/docs/key-concepts/query"
      ...
      <div className="container">
        ...
        <div className={styles.cardGrid}>
          <CardSection
            ...
            link="/docs/docs/category/key-concepts"
            icon={
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          ...
          <CardSection
            ...
            link="/docs/docs/design-choices#highlights"
            icon={
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
